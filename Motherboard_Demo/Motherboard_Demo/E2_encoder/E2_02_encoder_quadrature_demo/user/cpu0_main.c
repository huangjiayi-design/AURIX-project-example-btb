...
// 接入正交编码器连接 2
//      模块管脚            单片机管脚
//      A                   ENCODER_2_A 宏定义的引脚 默认 P10_3
//      B                   ENCODER_2_B 宏定义的引脚 默认 P10_1
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
// 接入正交编码器连接 3
//      模块管脚            单片机管脚
//      A                   ENCODER_3_A 宏定义的引脚 默认 P02_8
//      B                   ENCODER_3_B 宏定义的引脚 默认 P00_9
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
// 接入正交编码器连接 4
//      模块管脚            单片机管脚
//      A                   ENCODER_4_A 宏定义的引脚 默认 P20_3
//      B                   ENCODER_4_B 宏定义的引脚 默认 P20_0
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
...
int core0_main(void)
{
	...
	while (TRUE)
	{
	    ...
	    printf("ENCODER_1 :%d .ENCODER_3 :%d .\r\n", encoder_data_1, encoder_data_3);                 // 输出编码器计数信息
	    system_delay_ms(100);
