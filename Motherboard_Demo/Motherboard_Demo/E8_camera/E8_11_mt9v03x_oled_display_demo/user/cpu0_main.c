...
int core0_main(void)
{
    ...
    while (TRUE)
    {
        ...
        {
            oled_displayimage03x((const uint8 *)mt9v03x_image_1, 64);   // 我们不建议使用 oled 查看图像 缩放效果显示效果极差 建议使用 TFT/IPS 系列屏幕
//            oled_displayimage03x_zoom((const uint8 *)mt9v03x_image_1, MT9V03X_1_W, MT9V03X_1_H, 128, 64, 64);
//            oled_show_gray_image(0, 0, (const uint8 *)mt9v03x_image_1, MT9V03X_1_W, MT9V03X_1_H, 128, 64, 64);
