...
int core0_main(void)
{
    ...
    while (TRUE)
    {
        ...
        {
//            tft180_displayimage03x((const uint8 *)mt9v03x_image_1, MT9V03X_1_W, MT9V03X_1_H);   // 需要注意 直接显示 188*120 分辨率是显示不下的 会直接进入断言报错 所以这一句在默认分辨率下无法使用
            tft180_displayimage03x((const uint8 *)mt9v03x_image_1, 160, 128);
//            tft180_show_gray_image(0, 0, (const uint8 *)mt9v03x_image_1, MT9V03X_1_W, MT9V03X_1_H, 160, 128, 0);
