...
int core0_main(void)
{
    ...
    while (TRUE)
    {
        ...
        {
            ips114_displayimage03x((const uint8 *)mt9v03x_image_1, MT9V03X_1_W, MT9V03X_1_H);                             // 显示原始图像
//            ips114_show_gray_image(0, 0, (const uint8 *)mt9v03x_image_1, MT9V03X_1_W, MT9V03X_1_H, 240, 135, 64);       // 显示灰度图像
