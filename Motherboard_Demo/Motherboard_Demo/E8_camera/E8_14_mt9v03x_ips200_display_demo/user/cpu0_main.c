...
#define IPS200_TYPE     (IPS200_TYPE_SPI)                                       // 排针 并口两寸屏 这里宏定义填写 IPS200_TYPE_PARALLEL8
                                                                                      // 排针 SPI 两寸屏 这里宏定义填写 IPS200_TYPE_SPI
...
int core0_main(void)
{
    ...
    while (TRUE)
    {
        ...
        {
            ips200_displayimage03x((const uint8 *)mt9v03x_image_1, MT9V03X_1_W, MT9V03X_1_H);                       // 显示原始图像
